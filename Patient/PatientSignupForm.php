...
<body>
    ...
    <form name="patientForm" action="" method="post">
        ...
        <div class="input-group col-xs-7">
            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            <input type="text" class="form-control" id="username" name="username" pattern='[A-Za-z\\s]*' placeholder="Username" onkeyup='checkUserName(this.value)' onblur="blurFunction(this.name)" required>
        </div> <div class="valDiv" id="usernameDiv"></div> 
                <div class="valDiv" id="usernamecheck">Username already Taken</div>     <br>

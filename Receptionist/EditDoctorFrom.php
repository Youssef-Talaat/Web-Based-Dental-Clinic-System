        ...
        <?php
            ...
            echo "<form action='' method='post'>
                    ...
                    <div class='container'>
                        ...
                        <input class='form-control col-8' type='text' id='username' name='username' placeholder='john123' value='".$_SESSION['userToEdit']->username."' onblur='blurFunction(this.name)' required><br>
